...
public class AirportService {
    public Plane creatPlane() {
        ...
        System.out.println("Is Militery plane? Y/N");
        String m = s.next(); //String m = s.next().toLowerCase();
        plane.setMilitary(m.charAt(0) == 'Y' || m.charAt(0) == 'y'); //plane.setMilitary(m.charAt(0) == 'y');
        return plane;
    }
